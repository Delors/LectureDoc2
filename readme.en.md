...
[http-server](https://www.npmjs.com/package/http-server) (from npm) can be used:
...
```{literalinclude} src/docs/minimal-example.html
:language: html
```
...
In general, we highly recommend to author your slides in LectureDoc2-Myst and use `LectureDoc2Author` to create your slide set. `LectureDoc2Author` is Markdown based and offers a wide range of features that makes using LectureDoc fun to use.
:::
